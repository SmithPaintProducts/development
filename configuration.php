...
class JConfig {
	/**
	* -------------------------------------------------------------------------
	* Site configuration section tinymce
	* -------------------------------------------------------------------------
	*/
	/* Site Settings */
	var $offline = '0';
	var $offline_message = 'This site is down for maintenance.<br /> Please check back again soon.';
	var $sitename = 'Smith Paint Products';			// Name of Joomla site
	var $editor = 'tinymce';
	var $list_limit = '20';
	var $legacy = '0';
	...
	*/
	...
	var $user = 'smithpai_jo151';							// MySQL username
	var $password = 'QXZud[T6Ih8X';						// MySQL password
	var $db = 'smithpai_jo151';							// MySQL database name
	...
	/* Mail Settings */
	var $mailer = 'mail';
	var $mailfrom = 'info@smithpaints.com';
	var $fromname = 'Smith Paints';
	...
	/* Meta Settings */
	var $MetaDesc = 'Smith Paint Products is an environmentally-friendly paint manufacturing company located in Harrisburg, Pennsylvania.';
	var $MetaKeys = 'paint, concrete, environmentally-friendly, manufacturing, Harrisburg, PA ';
	var $MetaTitle = '1';
	var $MetaAuthor = '1';
